...
static int PD_mfa_u;				// Number of facets that include point u
...
static int PD_TWIDDLE_nextFacetI;	// Next index of facet in TWIDDLE algorithm
...
static int PD_facetNeHyperplanes[PP_N - 1];	// Index of inequality-hyperplanes used for pseudoprojection
static int PD_facetAlHyperplanes[PP_N - 1];	// Index of all hyperplanes used for pseudoprojection
static int PD_facetCodes[PP_KK];			// Facet codes
